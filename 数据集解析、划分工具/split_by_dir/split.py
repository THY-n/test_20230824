...
if __name__ == '__main__':
    ...
    parser.add_argument('--image-dir', type=str, default=r'D:\data\dataset_yolov8_seg\datasets\images', help='image path dir')
    parser.add_argument('--txt-dir', type=str, default=r'D:\data\dataset_yolov8_seg\datasets\txt', help='txt path dir')
    parser.add_argument('--save-dir', default=r'D:\data\dataset_yolov8_seg\datasets\split', type=str, help='save dir')
